...
<head>
  ...
  <header style="border-radius: 25px;background-image: url(headrer.jpg);">
    ...
    <body>
    <div class="form-box">
    <form  method="post" action="payment_booking.php">
      <label>UserID &nbsp;&nbsp;</label>
      <input type="text" name="U_ID" value="<?php echo $username; ?>" readonly>

      <br>

      <label>Distance &nbsp;&nbsp;</label>
      <input type="text" id="distanceInput" name="dist">
      
      <br>
      <label>Rent-A-Car On &nbsp;&nbsp;&nbsp;</label>
      <input type="date" id="datePick" onclick="Datefn()" name="date">
      <br>


    <p>Amount to pay per km: <span id="selected-amount"></span></p> 
...
<br>
  ...
  <label for="cashPayment">
    <input type="checkbox" style="width:70px;height:45px"; id="cashPayment" name="paymentMethod" value="cash"><h2>Pay with Cash</h2>
  </label>
  
    <p>Card Payment</p>
  
    <center><div class="payment-icons">
      <i class="fab fa-cc-visa"></i>
      <i class="fab fa-cc-mastercard"></i>
      <i class="fab fa-cc-paypal"></i>
    </div></center><br><br>
      <label for="name">Card holder's name<br></label>
      <input type="text" id="name" name="name"><br>
  
      <label for="card number">Card number<br></label>
      <input type="text" id="card number" name="cardnumber"><br>

      <label for="Expiry">Expiry<br></label>
        <input type="month number and year" id="month number and year" name="expiry"><br>

      <label for="cvc">CVC<br></label>
          <input type="text" id="number" name="cvc"><br>
          

      <input  type="submit" name="submit" value="submit" style="width: 125px; height: 60px; border-radius: 25px;" ><br>
